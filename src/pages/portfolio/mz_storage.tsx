    ...
    <>
      ...
      <Layout_P title="Storage">
        ...
        <PageItem title="Этапы разработки">
          <Steps
            items={[
              'Сбор информации: назначение, основные цели',
              'Планирование: создание структуры приложения, БД',
              'Прототипирование базы данных',
              'Разработка сервера и API, Express',
              'Разработка клиентской части, React + Redux-toolkit',
              'Тестирование API',
            ]}
          />
        </PageItem>
